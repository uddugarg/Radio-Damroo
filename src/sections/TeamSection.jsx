...
import img2 from '../assets/celebrities/anil-kapoor.jpg';
import img3 from '../assets/celebrities/anil-kapoor.jpg';
import img4 from '../assets/celebrities/anil-kapoor.jpg';
    ...
    return (
        <Section ref={ref} id="fixed-target" className="new-arrival">
            ...
            <Container ref={ScrollingRef}>
                <Photos img={img1} name="There is new collection available for cool clothes in all sizes. This collection is a great way to find a new look for you. It offers a variety of cool apparel styles to fit your taste, while you can also find some cool clothes that you can wear everyday." />
